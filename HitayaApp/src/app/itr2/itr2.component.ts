...
@Component({
  selector: 'app-itr2',
  templateUrl: './itr2.component.html',
  styleUrls: ['./itr2.component.scss']
})
export class Itr2Component implements OnInit {
  ...
  submititr2(form: NgForm) {
    ...
    this.tax.UpdateTaxInformtion(this.tax_values).subscribe(
      ...
      () => console.log("ITR2 Form method executed successfully")
    );
  }
