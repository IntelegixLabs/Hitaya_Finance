...
@Component({
  selector: 'app-itr4',
  templateUrl: './itr4.component.html',
  styleUrls: ['./itr4.component.scss']
})
export class Itr4Component implements OnInit {
  ...
  submititr4(form: NgForm) {

    console.log("ITR4 Form");
    ...
    this.tax.UpdateTaxInformtion(this.tax_values).subscribe(
      ...
      () => console.log("ITR4 Form method executed successfully")
    );
  }
